object frmMstServicePrice: TfrmMstServicePrice
  Left = 90
  Top = 153
  Width = 776
  Height = 481
  Caption = 'frmMstServicePrice'
  Color = clWhite
  ...
  object pnlTarif: TsuiPanel
    ...
    object gridTarif: TAdvStringGrid
      Left = 4
      Top = 65
      Width = 576
      Height = 378
      ...
      OnGetAlignment = gridTarifGetAlignment
      OnRowChanging = gridRowChanging
      OnCanEditCell = gridTarifCanEditCell
      OnCellValidate = gridTarifCellValidate
      OnGetEditorType = gridTarifGetEditorType
      DragDropSettings.OleAcceptFiles = True
      DragDropSettings.OleAcceptText = True
      SortSettings.AutoColumnMerge = False
      ...
      RowHeights = (
        ...
        21
        15)
      object gridExcel: TAdvStringGrid
        Left = 80
        Top = 144
        Width = 320
        Height = 120
