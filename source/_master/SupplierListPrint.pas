...
type
  TqrpSupplierList = class(TQuickRep)
    TitleBand1: TQRBand;
...
var
  qrpSupplierList: TqrpSupplierList;
...
procedure TqrpSupplierList.Executes(AGrid: TAdvStringGrid);
begin
  Grid:= AGrid;
  ...
  i:= 1;
  qrpSupplierList.Prepare;
  PreviewModal;
end;

procedure TqrpSupplierList.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  i:= 1;
end;

procedure TqrpSupplierList.QuickRepNeedData(Sender: TObject;
...
begin
  ...
  if MoreData then begin
   ...
   //alamatLah
     ...
     qrlSaldo.Caption:= Grid.Cells[colKota, i];
