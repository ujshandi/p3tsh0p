	...
	public
	  { Public-Deklarationen }
		...
		procedure DrawText(Canvas:TCanvas);
                procedure ClearBarcode(Canvas:TCanvas);
	published
	...
	begin
		...
		if FShowText in [bcoCode, bcoBoth] then
			TextOut(FLeft, FTop, FText);         {contents of Barcode}
                        //TextOut(FLeft, posisi, FText);         {contents of Barcode}
...
procedure TBarcode.ClearBarcode(Canvas: TCanvas);
var
    saveFont: TFont;
    SavePen: TPen;
    SaveBrush: TBrush;
