object frmTrsPembayaran: TfrmTrsPembayaran
  Left = 192
  Top = 177
  Width = 556
  Height = 462
  Caption = 'Pembayaran Utang Dagang'
  Color = clWhite
  ...
  object suiPanel1: TsuiPanel
    ...
    object Label4: TLabel
      ...
      Height = 39
      Caption = 
        '1: Tunai, 2: GIRO, 3: CEK'#13#10'pengurang DEBT: subtotal + discount'#13#10 +
        'pengurang KAS  : grandtotal'
      Visible = False
    end
    ...
    object btnFaktur: TButton
      ...
      TabOrder = 4
      TabStop = False
      OnClick = btnFakturClick
    end
    object txtTagihan: TAdvEdit
      Left = 97
      Top = 75
      Width = 230
      Height = 24
    ...
    object txtDiscount: TAdvEdit
      ...
      OnChange = txtSpecChange
      OnEnter = txtSpecEnter
      OnExit = txtDiscountExit
      OnKeyPress = txtDiscountKeyPress
    end
